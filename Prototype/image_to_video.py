...
def resize_image_to_phone_camera(image_path, output_path, target_width=1080, target_height=1920, rotate=None,
    ...
    Uses platform config values instead of path-based detection.
    """
    try:
        with Image.open(image_path) as img:
            ...
            if rotate is not None and abs(rotate) in (90, -90, 270, -270):
...
def push_image_to_gallery(app_instance, platform_config):
    ...
    app_instance.info_label.configure(text=f"Resizing image to {width}x{height}...")
